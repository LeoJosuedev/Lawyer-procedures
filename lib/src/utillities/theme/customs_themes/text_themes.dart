...
class TTextTheme{
  ...
  static TextTheme lighTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w500, color: Colors.black),
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.black),
    labelMedium: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
      );
  static TextTheme darkTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
  );
}